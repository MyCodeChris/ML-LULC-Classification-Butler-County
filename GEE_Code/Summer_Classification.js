...
var filtered = s2
  ...
  .filter(ee.Filter.date('2024-07-15', '2024-08-31'))
...
Map.addLayer(classified.clip(butler), {min: 0, max: 5, palette: palette}, 'Classified');
...
Export.table.toDrive({
  collection: fc,
  description: 'kNN_Summer_confusion_matrix_csv',
  fileFormat: 'CSV'
});
...
//To download the data for a particular algorithm. make sure to change the file name to fit
// the active algorithm

Export.image.toDrive({
image: classified,
description: 'summer_Cart',
folder: 'pub_images',
fileNamePrefix: 'summer_Cart',
region: butler,
scale: 30,
maxPixels: 1e9
});
